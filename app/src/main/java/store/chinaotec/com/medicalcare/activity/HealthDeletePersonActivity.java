 ...
 * 删除健康管理人员
 */
public class HealthDeletePersonActivity extends AppCompatActivity {
    ...
    private void initData() {
        OkHttpUtils.post().url(MyUrl.HEALTH_CONTROL)
                .addParams("sid", sid)
                .build().execute(new StringCallback() {
            @Override
            public void onError(Call call, Exception e, int id) {
                Toast.makeText(HealthDeletePersonActivity.this, "网络异常", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onResponse(String response, int id) {
                ...
                if ("0".equals(healthControlBean.getResponseCode())) {
                    ...
                    Toast.makeText(HealthDeletePersonActivity.this, healthControlBean.getMsg(), Toast.LENGTH_SHORT).show();
                }
    ...
    class HealthPersonAdapter extends RecyclerView.Adapter<HealthPersonAdapter.ViewHolder>{
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new ViewHolder(LayoutInflater.from(HealthDeletePersonActivity.this).inflate(R.layout.item_delete_dise, parent, false));
        }

        @Override
        public void onBindViewHolder(ViewHolder holder, final int position) {
            holder.personName.setText(data.get(position).getName());
                ...
                public void onClick(View view) {
                    ...
                    deleteUserDiseDialog.setDeleteDiseSure(new DeleteUserDiseDialog.SureDeleteDiseListener() {
                        ...
                        public void sureDelete() {
                            OkHttpUtils.post().url(MyUrl.HEALTH_DELETE_PERSON).addParams("sid",sid).
                                    addParams("patientId",data.get(position).getPatientId()).build().execute(new StringCallback() {
                                @Override
                                public void onResponse(String response, int id) {
                                    ...
                                    if ("0".equals(result.responseCode)){
                                        ...
                                        ToastUtil.MyToast(HealthDeletePersonActivity.this,result.msg);
                                    }
                                }
                                @Override
                                public void onError(Call call, Exception e, int id) {
