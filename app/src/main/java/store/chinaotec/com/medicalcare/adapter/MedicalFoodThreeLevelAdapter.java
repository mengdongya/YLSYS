 ...
 */
public class MedicalFoodThreeLevelAdapter extends RecyclerView.Adapter<MedicalFoodThreeLevelAdapter.ViewHolder> {

    private final Context context;
    private final MedicalBookBean.DataBean.MedicalTypeListBean.DataChildTypeList data;

    public MedicalFoodThreeLevelAdapter(Context context, MedicalBookBean.DataBean.MedicalTypeListBean.DataChildTypeList dataChildTypeList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.rv_result_check.setAdapter(new MedicalFoodThreeLevelDataAdapter(context,data.getChildTypeList().get(position).getDataList()
