...
public class MyDiseaseTimeLineAdapter extends RecyclerView.Adapter<MyDiseaseTimeLineAdapter.ViewHolder> {

    private Context context;
    private List<ChronicDiseaseBean.DataBean.ChronicPatientDto.PatientDto.DiseaseRecordDtosBean> diseaseRecordDtos;
    ...
    public MyDiseaseTimeLineAdapter(Context context, List<ChronicDiseaseBean.DataBean.ChronicPatientDto.PatientDto.DiseaseRecordDtosBean> diseaseRecordDtos) {
