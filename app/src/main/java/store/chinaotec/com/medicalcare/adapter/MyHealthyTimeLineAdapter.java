...
public class MyHealthyTimeLineAdapter extends RecyclerView.Adapter<MyHealthyTimeLineAdapter.ViewHolder> {

    private Context context;
    List<HealthControlBean.DataBean.PatientDtosBean.DiseaseRecordDtosBean> diseaseRecordDtos;
    ...
    public MyHealthyTimeLineAdapter(Context context, List<HealthControlBean.DataBean.PatientDtosBean.DiseaseRecordDtosBean> diseaseRecordDtos) {
