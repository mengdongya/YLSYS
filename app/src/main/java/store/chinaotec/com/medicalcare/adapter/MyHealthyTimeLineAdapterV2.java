...
public class MyHealthyTimeLineAdapterV2 extends RecyclerView.Adapter<MyHealthyTimeLineAdapterV2.ViewHolder> {

    private Context context;
    private List<HealthyRecordBean.DataBean.PatientDtoBean.DiseaseRecordDtosBean> diseaseRecordDtos;
    ...
    public MyHealthyTimeLineAdapterV2(Context context, List<HealthyRecordBean.DataBean.PatientDtoBean.DiseaseRecordDtosBean> diseaseRecordDtos) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_health_time_line, parent, false);
...
//        }
        ...
        holder.checkInoculation.setText(diseaseRecordDtos.get(position).getInoculate());
        holder.checkContraception.setText(diseaseRecordDtos.get(position).getContraception());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @Bind(R.id.check_inoculation)
        TextView checkInoculation;
        @Bind(R.id.check_contraception)
        TextView checkContraception;
