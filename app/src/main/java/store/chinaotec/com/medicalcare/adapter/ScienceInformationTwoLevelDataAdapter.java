 ...
 */
public class ScienceInformationTwoLevelDataAdapter extends RecyclerView.Adapter<ScienceInformationTwoLevelDataAdapter.ViewHolder> {
    private final Context context;
    private final MedicalBookBean.DataBean.MedicalTypeListBean.DataChildTypeList data;

    public ScienceInformationTwoLevelDataAdapter(Context context, MedicalBookBean.DataBean.MedicalTypeListBean.DataChildTypeList dataChildTypeList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.rv_result_check.setAdapter(new ScienceInformationThreeLevelDataAdapter(context,data.getChildTypeList().get(position).getDataList()
                .get(0).getMedicalBookList()));
