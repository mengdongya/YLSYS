 ...
 * 慢性病管理
 */
public class ChronicDiseaseManagerFragment2 extends Fragment implements View.OnClickListener {
    ...
    public static ChronicDiseaseManagerFragment2 newInstance(ChronicDiseaseBean.DataBean.ChronicPatientDto chronicPatientDto) {
        Bundle bundle = new Bundle();
        bundle.putSerializable("chronicPatientDto",chronicPatientDto);
        ChronicDiseaseManagerFragment2 fragment = new ChronicDiseaseManagerFragment2();
