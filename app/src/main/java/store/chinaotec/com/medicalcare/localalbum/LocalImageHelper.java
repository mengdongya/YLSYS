 ...
 */
public class LocalImageHelper extends Activity {
    //大图遍历字段
    ...
    public String setCameraImgPath() {
        String foloder = MyApp.getContext().getCachePath()
                + "/PostPicture/";
    ...
    private void beginInitImage() {
        ...
        while (cursor.moveToNext()) {
            ...
            int columnIndex = cursor.getColumnIndex(STORE_IMAGES[1]);
            ...
            if (file.exists()) {
                ...
                localFile.setImageUrl(picturePath);
    ...
    public static class LocalFile {
         ...
         * 是否为网络图片，默认否
         */
        public boolean isNetUrl = false;
        /**
         * 图片的id，只有网络图片才有id
         */
        public String id = null;
        private String originalUri;//原图URI
        private String imageUrl;//原图URI2
        private String thumbnailUri;//缩略图URI
        private int orientation = 0;//图片旋转角度
        private Bitmap bitmap;

        public LocalFile() {
        }

        public LocalFile(String originalUri, boolean isNetUrl, String id) {
        ...
        public Bitmap getBitmap() {
            if (bitmap == null) {
//                try {
//                    bitmap = BitmapUtils.revitionImageSize(getImageUrl());
//                } catch (IOException e) {
//                    e.printStackTrace();
//                }
                bitmap = BitmapUtils.getimage(getImageUrl());
            }
//            return Bimp.getSmallBitmap(getOriginalUri());
            return bitmap;
        }
