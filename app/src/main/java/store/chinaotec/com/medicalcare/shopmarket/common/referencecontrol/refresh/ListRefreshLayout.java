...
public class ListRefreshLayout extends LinearLayout {
    //下拉头部回滚的速度
    ...
    private void init() {
        ...
        if (isInEditMode()) {
            System.out.println("添加header失败");
            return;
        }
        addHeaderView();
        System.out.println("添加header成功");
    }
    ...
    private void addHeaderView() {
        mHeaderView = mInflater.inflate(R.layout.shop_market_new_refresh_header, this, false);
...
//		mFooterView = mInflater.inflate(R.layout.new_refresh_footer, this, false);
...
//		addView(mFooterView, params);
    ...
    protected void onFinishInflate() {
        ...
        if (isInEditMode()) {
            System.out.println("添加footer失败");
            return;
        }
        addFooterView();
        System.out.println("添加footer成功");
    ...
    private void footerRefreshing() {
        ...
        mFooterTextView.setGravity(Gravity.LEFT);
        mFooterTextView
    ...
    public interface OnFooterRefreshListener {
        public void onFooterRefresh(ListRefreshLayout view);
    }
    ...
    public interface OnHeaderRefreshListener {
        public void onHeaderRefresh(ListRefreshLayout view);
    }
