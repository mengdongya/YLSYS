...
public class BGABadgeViewHelper {
    ...
    public BGABadgeViewHelper(BGABadgeable badgeable, Context context,
    ...
    private void initDefaultAttrs(Context context,
        ...
        mBadgeTextSize = sp2px(context, 12);
        ...
        mBadgeVerticalMargin = dp2px(context, 1);
        mBadgeHorizontalMargin = dp2px(context, 30);
