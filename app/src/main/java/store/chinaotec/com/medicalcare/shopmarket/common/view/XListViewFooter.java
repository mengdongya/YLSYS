...
//			mHintView.setText(R.string.xlistview_footer_hint_normal);
    ...
    private void initView(Context context) {
        mContext = context;
        LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.news_xlistview_footer, null);
        addView(moreView);
    ...
    //XGridView提供view刷新；
    public void setViewHeightChange(ViewHeightChange viewHeightChange) {
