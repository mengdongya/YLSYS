...
public class WheelOptions {
    ...
    private ArrayList<DistrictModel> mOptions1Items;
    private ArrayList<ArrayList<DistrictModel>> mOptions2Items;
    private ArrayList<ArrayList<ArrayList<DistrictModel>>> mOptions3Items;
    ...
    public void setPicker(ArrayList<DistrictModel> optionsItems) {
        setPicker(optionsItems, null, null, false);
    }

    public void setPicker(ArrayList<DistrictModel> options1Items,
                          ArrayList<ArrayList<DistrictModel>> options2Items, boolean linkage) {
        setPicker(options1Items, options2Items, null, linkage);
    }

    public void setPicker(ArrayList<DistrictModel> options1Items,
                          ArrayList<ArrayList<DistrictModel>> options2Items,
        ...
        int textSize = (int) ((screenheight / 100) * 3.5);
