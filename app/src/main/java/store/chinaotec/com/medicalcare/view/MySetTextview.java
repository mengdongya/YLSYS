 ...
 * 自定义文本带提示
 */
public class MySetTextview extends android.support.v7.widget.AppCompatTextView {
    ...
    public MySetTextview(Context context) {
        this(context, null);
    }

    public MySetTextview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MySetTextview(Context context, AttributeSet attrs, int defStyleAttr) {
